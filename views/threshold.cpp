...
void Threshold::bindToOp(ThresholdOp *co)
{
	...
	QObject::connect(ui->bgWindowSlider, SIGNAL(valueChanged(int)), co, SLOT(updateWindowBG(int)));
	...
	QObject::connect(ui->thWindowSlider, SIGNAL(valueChanged(int)), co, SLOT(updateWindowTH(int)));
